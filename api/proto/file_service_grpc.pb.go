...
type FileServiceClient interface {
	...
	ListFiles(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListResponse, error)
}
...
func (c *fileServiceClient) ListFiles(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type FileServiceServer interface {
	...
	ListFiles(context.Context, *emptypb.Empty) (*ListResponse, error)
...
func (UnimplementedFileServiceServer) ListFiles(context.Context, *emptypb.Empty) (*ListResponse, error) {
