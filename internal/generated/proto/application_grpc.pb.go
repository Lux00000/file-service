...
type FileServiceClient interface {
	UploadFile(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[FileChunk, FileInfo], error)
...
func (c *fileServiceClient) UploadFile(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[FileChunk, FileInfo], error) {
...
type FileService_UploadFileClient = grpc.ClientStreamingClient[FileChunk, FileInfo]
...
type FileServiceServer interface {
	UploadFile(grpc.ClientStreamingServer[FileChunk, FileInfo]) error
...
func (UnimplementedFileServiceServer) UploadFile(grpc.ClientStreamingServer[FileChunk, FileInfo]) error {
...
func _FileService_UploadFile_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(FileServiceServer).UploadFile(&grpc.GenericServerStream[FileChunk, FileInfo]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type FileService_UploadFileServer = grpc.ClientStreamingServer[FileChunk, FileInfo]
